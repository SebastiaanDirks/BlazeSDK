...
public class PersonaInfo : Tdf
{
    ...
    private TdfEnum<Blaze15SDK.Blaze.Authentication.PersonaStatus> _status = new(__typeInfos[5]);
    private TdfEnum<Blaze15SDK.Blaze.Authentication.StatusReason> _statusReasonCode = new(__typeInfos[6]);

    public PersonaInfo()
    {
        __members = [ _displayName, _dateCreated, _lastAuthenticated, _nameSpaceName, _personaId, _status, _statusReasonCode ];
    }
    ...
    public uint LastAuthenticated { get => _lastAuthenticated.Value; set => _lastAuthenticated.Value = value; }
    public string NameSpaceName { get => _nameSpaceName.Value; set => _nameSpaceName.Value = value; }
    public long PersonaId { get => _personaId.Value; set => _personaId.Value = value; }
    public Blaze15SDK.Blaze.Authentication.PersonaStatus Status { get => _status.Value; set => _status.Value = value; }
