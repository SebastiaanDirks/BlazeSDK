...
public class Entitlement : Tdf
{
    ...
    private TdfEnum<Blaze15SDK.Blaze.Authentication.ProductCatalog> _productCatalog = new(__typeInfos[7]);
    private TdfString _productId = new(__typeInfos[8]);
    private TdfEnum<Blaze15SDK.Blaze.Authentication.EntitlementStatus> _status = new(__typeInfos[9]);
    private TdfEnum<Blaze15SDK.Blaze.Authentication.StatusReason> _statusReasonCode = new(__typeInfos[10]);
    ...
    public string DeviceUri { get => _deviceUri.Value; set => _deviceUri.Value = value; }
    ...
    public bool IsConsumable { get => _isConsumable.Value; set => _isConsumable.Value = value; }
    ...
    public string TerminationDate { get => _terminationDate.Value; set => _terminationDate.Value = value; }
    ...
    public uint UseCount { get => _useCount.Value; set => _useCount.Value = value; }
