...
public class ListEntitlementsRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("EntitlementSearchFlag", "mEntitlementSearchFlag", 0x9AC86700, TdfType.Int32, 3, true), // FLAG
        new TdfMemberInfo("GroupNameList", "mGroupNameList", 0x9EE8CC00, TdfType.List, 4, true), // GNLS
    ];
    ...
    {
        __members = [ _blazeId, _pageSize, _pageNo, _entitlementSearchFlag, _groupNameList ];
    }
