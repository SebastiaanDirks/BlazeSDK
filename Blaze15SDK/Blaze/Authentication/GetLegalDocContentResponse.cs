...
public class GetLegalDocContentResponse : Tdf
{
    ...
    {
        __members = [ _legalDocVersion, _legalDocContentLength, _legalDocContent ];
    }
    ...
    public string LegalDocVersion { get => _legalDocVersion.Value; set => _legalDocVersion.Value = value; }
    public uint LegalDocContentLength { get => _legalDocContentLength.Value; set => _legalDocContentLength.Value = value; }
    public string LegalDocContent { get => _legalDocContent.Value; set => _legalDocContent.Value = value; }
}
