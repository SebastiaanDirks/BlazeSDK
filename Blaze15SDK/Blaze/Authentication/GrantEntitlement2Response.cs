...
public class GrantEntitlement2Response : Tdf
{
    ...
    private TdfStruct<Blaze15SDK.Blaze.Authentication.Entitlement?> _entitlementInfo = new(__typeInfos[0]);
    private TdfBool _isGranted = new(__typeInfos[1]);

    public GrantEntitlement2Response()
    {
        __members = [ _entitlementInfo, _isGranted ];
    }
    ...
    public Blaze15SDK.Blaze.Authentication.Entitlement? EntitlementInfo { get => _entitlementInfo.Value; set => _entitlementInfo.Value = value; }
    public bool IsGranted { get => _isGranted.Value; set => _isGranted.Value = value; }
}
