...
public class DecrementUseCount : Tdf
{
    ...
    public DecrementUseCount() { __members = [ _useCountConsumed, _useCountRemain ]; }
    ...
    public uint UseCountConsumed { get => _useCountConsumed.Value; set => _useCountConsumed.Value = value; }
    public uint UseCountRemain { get => _useCountRemain.Value; set => _useCountRemain.Value = value; }
}
