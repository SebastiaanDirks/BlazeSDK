...
public class PostEntitlementRequest : Tdf
{
    ...
    private TdfEnum<Blaze15SDK.Blaze.Authentication.EntitlementStatus> _status = new(__typeInfos[5]);
    private TdfString _entitlementTag = new(__typeInfos[6]);

    public PostEntitlementRequest()
    {
        __members = [ _deviceId, _groupName, _withPersona, _projectId, _productId, _status, _entitlementTag ];
    }
    ...
    public uint DeviceId { get => _deviceId.Value; set => _deviceId.Value = value; }
