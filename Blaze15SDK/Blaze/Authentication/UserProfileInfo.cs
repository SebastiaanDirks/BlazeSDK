...
public class UserProfileInfo : Tdf
{
    ...
    private TdfMap<string, IDictionary<string, string>> _profileInfoElementsByCategory = new(__typeInfos[2]);
    private TdfEnum<Blaze15SDK.Blaze.Authentication.Gender> _gender = new(__typeInfos[3]);
    private TdfString _state = new(__typeInfos[4]);
    private TdfString _street = new(__typeInfos[5]);
    private TdfInt64 _accountId = new(__typeInfos[6]);
    private TdfString _zipCode = new(__typeInfos[7]);

    public UserProfileInfo()
    {
        __members = [ _city, _country, _profileInfoElementsByCategory, _gender, _state, _street, _accountId, _zipCode ];
    }
    ...
    public string City { get => _city.Value; set => _city.Value = value; }
    public string Country { get => _country.Value; set => _country.Value = value; }
    public IDictionary<string, IDictionary<string, string>> ProfileInfoElementsByCategory { get => _profileInfoElementsByCategory.Value; set => _profileInfoElementsByCategory.Value = value; }
    public Blaze15SDK.Blaze.Authentication.Gender Gender { get => _gender.Value; set => _gender.Value = value; }
    public string State { get => _state.Value; set => _state.Value = value; }
    public string Street { get => _street.Value; set => _street.Value = value; }
    public long AccountId { get => _accountId.Value; set => _accountId.Value = value; }
    public string ZipCode { get => _zipCode.Value; set => _zipCode.Value = value; }
}
