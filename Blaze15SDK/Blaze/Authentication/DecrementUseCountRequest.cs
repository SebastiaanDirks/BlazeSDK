...
public class DecrementUseCountRequest : Tdf
{
    ...
    public DecrementUseCountRequest() { __members = [ _decrementCount, _entitlementTag, _groupName, _projectId, _productId ]; }
    ...
    public uint DecrementCount { get => _decrementCount.Value; set => _decrementCount.Value = value; }
