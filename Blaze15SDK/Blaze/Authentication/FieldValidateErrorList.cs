...
public class FieldValidateErrorList : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.Authentication.FieldValidationError> _list = new(__typeInfos[0]);
    ...
    public IList<Blaze15SDK.Blaze.Authentication.FieldValidationError> List { get => _list.Value; set => _list.Value = value; }
}
