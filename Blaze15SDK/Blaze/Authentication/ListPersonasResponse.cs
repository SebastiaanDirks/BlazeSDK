...
public class ListPersonasResponse : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.Authentication.PersonaDetails> _list = new(__typeInfos[0]);
    ...
    public IList<Blaze15SDK.Blaze.Authentication.PersonaDetails> List { get => _list.Value; set => _list.Value = value; }
}
