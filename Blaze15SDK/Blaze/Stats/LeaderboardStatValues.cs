...
public class LeaderboardStatValues : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.Stats.LeaderboardStatValuesRow> _rows = new(__typeInfos[0]);
    ...
    public IList<Blaze15SDK.Blaze.Stats.LeaderboardStatValuesRow> Rows
    {
        get => _rows.Value;
