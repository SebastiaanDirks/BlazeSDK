...
public class UpdateStatsRequest : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.Stats.StatRowUpdate> _statUpdates = new(__typeInfos[0]);

    public UpdateStatsRequest()
    {
        __members = [ _statUpdates ];
    }
    ...
    public IList<Blaze15SDK.Blaze.Stats.StatRowUpdate> StatUpdates
    {
