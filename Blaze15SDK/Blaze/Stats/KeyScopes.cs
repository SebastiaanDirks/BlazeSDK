...
public class KeyScopes : Tdf
{
    ...
    private TdfMap<string, Blaze15SDK.Blaze.Stats.KeyScopeItem> _keyScopesMap = new(__typeInfos[0]);

    public KeyScopes()
    {
        __members = [ _keyScopesMap ];
    }
    ...
    public IDictionary<string, Blaze15SDK.Blaze.Stats.KeyScopeItem> KeyScopesMap
    {
