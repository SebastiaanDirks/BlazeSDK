...
public class ListRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("Group", "mGroup", 0x9F2C0000, TdfType.String, 0, true), // Tag: GRP
        new TdfMemberInfo("Owner", "mOwner", 0xBF7BB200, TdfType.String, 1, true), // Tag: OWNR
        new TdfMemberInfo("RowId", "mRowId", 0xCA990000, TdfType.UInt32, 2, true), // Tag: RID
