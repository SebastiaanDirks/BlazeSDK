...
public class UserDataResponse : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("UserDataList", "mUserDataList", 0xD6CCF400, TdfType.List, 0, true), // Tag: ULST
    ];
    private ITdfMember[] __members;

    private TdfList<Blaze15SDK.Blaze.UserData> _userDataList = new(__typeInfos[0]);
    ...
    public IList<Blaze15SDK.Blaze.UserData> UserDataList
    {
