...
public class ListMemberInfo : Tdf
{
    ...
    private TdfStruct<Blaze15SDK.Blaze.Association.ListMemberId?> _listMemberId = new(__typeInfos[0]);
    private TdfInt64 _timeAdded = new(__typeInfos[1]);

    public ListMemberInfo()
    {
        __members = [ _listMemberId, _timeAdded ];
    }
    ...
    public Blaze15SDK.Blaze.Association.ListMemberId? ListMemberId
    {
