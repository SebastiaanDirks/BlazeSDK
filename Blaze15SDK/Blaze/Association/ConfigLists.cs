...
public class ConfigLists : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.Association.ListData> _listsInfo = new(__typeInfos[0]);

    public ConfigLists()
    {
        __members = [ _listsInfo ];
    }
    ...
    public IList<Blaze15SDK.Blaze.Association.ListData> ListsInfo
    {
