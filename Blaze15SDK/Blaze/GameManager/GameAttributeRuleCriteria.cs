...
public class GameAttributeRuleCriteria : Tdf
{
    ...
    public GameAttributeRuleCriteria()
    {
        __members = [ _minFitThresholdName, _desiredValues ];
    }

    public override Tdf CreateNew() => new GameAttributeRuleCriteria();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "GameAttributeRuleCriteria";
    public override string GetFullClassName() => "Blaze::GameManager::GameAttributeRuleCriteria";
