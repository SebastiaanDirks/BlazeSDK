...
public class GameBrowserDataList : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.GameManager.GameBrowserGameData> _gameData = new(__typeInfos[0]);
    ...
    public IList<Blaze15SDK.Blaze.GameManager.GameBrowserGameData> GameData
    {
        get => _gameData.Value;
