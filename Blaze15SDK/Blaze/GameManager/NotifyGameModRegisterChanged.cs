...
public class NotifyGameModRegisterChanged : Tdf
{
    ...
    public NotifyGameModRegisterChanged()
    {
        __members = [ _gameId, _gameModRegister ];
    }

    public override Tdf CreateNew() => new NotifyGameModRegisterChanged();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "NotifyGameModRegisterChanged";
    public override string GetFullClassName() => "Blaze::GameManager::NotifyGameModRegisterChanged";
