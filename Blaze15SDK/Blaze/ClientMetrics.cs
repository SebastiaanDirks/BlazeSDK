...
public class ClientMetrics : Tdf
{
    ...
    private TdfEnum<Blaze15SDK.Blaze.BlazeUpnpFlags> _blazeFlags = new(__typeInfos[0]);
    ...
    private TdfEnum<Blaze15SDK.Blaze.UpnpStatus> _status = new(__typeInfos[5]);
    ...
    public Blaze15SDK.Blaze.BlazeUpnpFlags BlazeFlags
    {
    ...
    public Blaze15SDK.Blaze.UpnpStatus Status
    {
        get => _status.Value;
