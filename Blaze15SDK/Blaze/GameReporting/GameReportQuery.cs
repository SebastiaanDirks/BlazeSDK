...
public class GameReportQuery : Tdf
{
    ...
    private TdfList<GameReportColumnKey> _columnKeyList = new(__typeInfos[0]);
    private TdfList<GameReportFilter> _filterList = new(__typeInfos[1]);
    ...
    {
        __members = [ _columnKeyList, _filterList, _typeName, _maxGameReport, _name ];
    }
    ...
    public IList<GameReportColumnKey> ColumnKeyList
    {
