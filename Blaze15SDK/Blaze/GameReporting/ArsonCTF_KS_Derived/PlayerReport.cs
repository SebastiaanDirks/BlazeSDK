...
namespace Blaze15SDK.Blaze.GameReporting.ArsonCTF_KS_Derived;
...
public class PlayerReport : Tdf
{
    ...
    public override string GetFullClassName() => "Blaze::GameReporting::ArsonCTF_KS_Derived::PlayerReport";
