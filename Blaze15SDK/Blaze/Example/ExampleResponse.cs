...
namespace Blaze15SDK.Blaze.Example;
...
public class ExampleResponse : Tdf
{
    ...
    private TdfEnum<Blaze15SDK.Blaze.Example.ExampleResponse.ExampleResponseEnum> _regularEnum = new(__typeInfos[0]);
    private TdfList<int> _myList = new(__typeInfos[1]);
    private TdfMap<int, Blaze15SDK.Blaze.Example.ExampleRequest> _myMap = new(__typeInfos[2]);
    ...
    public Blaze15SDK.Blaze.Example.ExampleResponse.ExampleResponseEnum RegularEnum
    {
    ...
    public IDictionary<int, Blaze15SDK.Blaze.Example.ExampleRequest> MyMap
    {
        get => _myMap.Value;
