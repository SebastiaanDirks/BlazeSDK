...
public class GetDataRatesRequest : Tdf
{
    ...
    public GetDataRatesRequest()
    {
        __members = [ _authCredentials, _categoryName, _context ];
    }

    public override Tdf CreateNew() => new GetDataRatesRequest();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "GetDataRatesRequest";
    public override string GetFullClassName() => "Blaze::ByteVault::GetDataRatesRequest";
