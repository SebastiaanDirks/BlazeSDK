...
public class GetErrorRatesRequest : Tdf
{
    ...
    public GetErrorRatesRequest()
    {
        __members = [ _authCredentials, _categoryName, _context ];
    }

    public override Tdf CreateNew() => new GetErrorRatesRequest();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "GetErrorRatesRequest";
    public override string GetFullClassName() => "Blaze::ByteVault::GetErrorRatesRequest";
