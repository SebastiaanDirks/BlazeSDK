...
public class UserStringList : Tdf
{
    ...
    private TdfList<Blaze15SDK.Blaze.Util.UserText> _textList = new(__typeInfos[0]);
    ...
    public override string GetFullClassName() => "Blaze::GameManager::UserStringList";

    public IList<Blaze15SDK.Blaze.Util.UserText> TextList
    {
        get => _textList.Value;
